# Csaude Microfrontend Apps for Openmrs 3.x UI
...
```bash
yarn start --sources 'packages/<package-name-1>' --sources 'packages/<package-name-2>'
```
...
[draft a new release](https://github.com/csaude/csaude-esm-apps/releases/new). 
