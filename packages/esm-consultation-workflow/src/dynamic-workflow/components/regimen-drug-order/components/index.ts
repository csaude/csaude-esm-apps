...
export { default as RegimenDataSection } from './regimen-data-section.component';
export { default as RegimenSection } from './regimen-section.component';
export { default as TherapeuticLineSection } from './therapeutic-line-section.component';
