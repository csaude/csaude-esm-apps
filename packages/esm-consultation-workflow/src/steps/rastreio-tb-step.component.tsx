...
const RastreioTbStep: StepFormComponent<RastreioTb> = ({ values, setValues }) => {
  ...
  const hide = (values: RastreioTb) => !values.tbSymptoms || values.tbSymptoms === NO_CONCEPT_UUID;
  return (
    <>
      <h4>Rastreio TB</h4>
      <StepForm values={values} onSubmit={onSubmit}>
        <Obs name="tbSymptoms" conceptUuid="2eab4e55-d0d0-4fa8-8d23-b40eaaee44c8" rendering="select" />
        <Obs
          name="tbObservations"
          conceptUuid="e1de6d1e-1d5f-11e0-b929-000c29ad1d07"
          rendering="checkbox"
          hide={hide}
        />
      </StepForm>
